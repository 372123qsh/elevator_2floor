...
HD_PWD='E:/PersonalProgram/2019021402021/elevator_2floor/elevator_2floor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topsource.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topsource.tcl
