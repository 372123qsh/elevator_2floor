...
HD_PWD='E:/PersonalProgram/2019021402021/elevator_2floor/elevator_2floor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topsource.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topsource.tcl -notrace
